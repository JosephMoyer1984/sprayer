...
required_env_vars = ["USERNAMES", "PASSWORD", "CATCHERURL", "CATCHERTLS", "CREDENTIALS"]
missing_env_vars = [var for var in required_env_vars if os.getenv(var) is None and var != "CREDENTIALS"]
